            ...
            <div class="index_logonbox">
                ...
                <form action="SignUpUser.php" id="common-form" class="form-horizontal" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-8">
                            <input type="email" name="email" id ="email" autocomplete="off" class="form-control" tabindex="2" placeholder="name@gmail.com"  required>
                        </div>
                    </div>
                    <!-- Email -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-8">
                            <input type="password" id ="password" name="password" autocomplete="off" class="form-control" tabindex="3" placeholder="Password" required>
                        </div>
                    </div>
                    <!-- Password -->
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-8">
                            <input type="text"  name="mobile"   autocomplete="off" class="form-control" tabindex="4" placeholder="mobile number" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 ">
                            <b style="text-align: center; color: red;">*Email ID already exists</b></button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 ">
                            <button type="submit" tabindex="5" class="btn btn-default btn-xs-block">Sign up</button>
...
<section class="footerbtm boxs" style="    margin-top: 20px;">
    <div class="container">
